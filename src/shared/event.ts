...
export interface IEventProps<T = EventBus> {
 ...
 * 事件驱动器基类
 */
export class EventDriver<Engine extends EventBus = EventBus, Context = any>
 ...
 * 事件引擎
 */
export class EventBus extends Subscrible<ICustomEvent<any>> {
  ...
  attachEvents(
    ...
    this.drivers.forEach((EventDriver) => {
